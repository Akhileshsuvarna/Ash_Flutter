...
//         Offstage(
//             offstage: node.isFirstGreater ?? true,
//             child: Text(_getComparisonIcon(node.isFirstGreater),
//                 style: TextStyle(
//                   fontSize: 28,
//                 ))),
//         Flexible(
...
//       // TODO(Skandar): On landmark select check if all above are not null
//       // than display the offstage field by setting isFirstGreater value
//     }
//     setState(() {
//       isFirst
...
//   _getComparisonIcon(bool? isGreater) => isGreater != null
//       ? isGreater
//           ? '>'
//           : '<'
//       : '?';
